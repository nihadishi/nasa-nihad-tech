...
export default function MPCCard({ item, index }) {
  return (
    <div key={index} className="bg-white dark:bg-[#1a1a1a] border border-gray-200 dark:border-gray-800 rounded-xl overflow-hidden mb-6 hover:shadow-xl transition-shadow duration-300">
      <div className="border-l-4 border-emerald-500 p-6">
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white">Magnetopause Crossing</h3>
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">{item.mpcID}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="p-6 pt-0">
        ...
        <div className="p-4 bg-emerald-50/50 dark:bg-emerald-900/10 rounded-lg border border-emerald-200 dark:border-emerald-800 mb-6">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
                ...
                Crossings occur when this boundary moves past a spacecraft due to changes in solar wind pressure.
              </p>
            </div>
          </div>
        </div>
