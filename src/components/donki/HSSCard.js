...
export default function HSSCard({ item, index }) {
  return (
      ...
      <div className="border-l-4 border-blue-500 p-6">
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white">High Speed Stream</h3>
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">{item.hssID}</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
                High-speed streams are fast-moving streams of solar wind emanating from coronal holes on the Sun. 
                They can cause geomagnetic disturbances when they interact with Earth&apos;s magnetosphere.
              </p>
            </div>
          </div>
        </div>
